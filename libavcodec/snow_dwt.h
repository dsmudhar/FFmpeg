...
int ff_w53_32_c(MotionEstContext *me_ctx, uint8_t *pix1, uint8_t *pix2, ptrdiff_t line_size, int h);
int ff_w97_32_c(MotionEstContext *me_ctx, uint8_t *pix1, uint8_t *pix2, ptrdiff_t line_size, int h);
